...
local whitelistname = {'lololololololo123135', 'deltaninaski', '17kLorys', 'simitistan25', 'xkinq_Fxrce', 'ItzW3xx31', 'becometoprointps', 'deltaninaskiii', 'SanemiBestGiyuu', 'qazztr', 'TPS_BARBAROS', 'GlobalO2', 'OruspuCocuguDelta', 'ZaanoobYT', 'simitistan25', 'UgurcanCakirP', 'izlro', 'YTBR_DEOPBULL1', 'Erincabooo31', 'ablanidelim', 'Daglar358',} -- has strings ('',"") and in the strings u put the names
